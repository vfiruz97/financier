...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({User user, String token, bool isAuthed, bool checking});
...
class _$AuthStateImpl extends _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(user: $user, token: $token, isAuthed: $isAuthed, checking: $checking)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, user, token, isAuthed, checking);
...
abstract class _AuthState extends AuthState {
  const factory _AuthState(
      ...
      required final bool checking}) = _$AuthStateImpl;
