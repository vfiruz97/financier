...
/// @nodoc
mixin _$IncomeTransactionCreateEvent {
  @optionalTypeArgs
...
/// @nodoc
abstract class $IncomeTransactionCreateEventCopyWith<$Res> {
  factory $IncomeTransactionCreateEventCopyWith(
          IncomeTransactionCreateEvent value,
          $Res Function(IncomeTransactionCreateEvent) then) =
      _$IncomeTransactionCreateEventCopyWithImpl<$Res,
          IncomeTransactionCreateEvent>;
}

/// @nodoc
class _$IncomeTransactionCreateEventCopyWithImpl<$Res,
        $Val extends IncomeTransactionCreateEvent>
    implements $IncomeTransactionCreateEventCopyWith<$Res> {
  _$IncomeTransactionCreateEventCopyWithImpl(this._value, this._then);
  ...
  /// Create a copy of IncomeTransactionCreateEvent
...
class __$$AssignAccountImplCopyWithImpl<$Res>
    extends _$IncomeTransactionCreateEventCopyWithImpl<$Res,
...
class _$AssignAccountImpl implements _AssignAccount {
  ...
  @override
  String toString() {
    return 'IncomeTransactionCreateEvent.assignAccount(account: $account)';
  }
...
abstract class _AssignAccount implements IncomeTransactionCreateEvent {
...
class _$AssignCategoryIdImpl implements _AssignCategoryId {
  ...
  @override
  String toString() {
    return 'IncomeTransactionCreateEvent.assignCategoryId(categoryId: $categoryId)';
  }
...
abstract class _AssignCategoryId implements IncomeTransactionCreateEvent {
...
class __$$FixBalanceImplCopyWithImpl<$Res>
    extends _$IncomeTransactionCreateEventCopyWithImpl<$Res, _$FixBalanceImpl>
...
class _$FixBalanceImpl implements _FixBalance {
  ...
  @override
  String toString() {
    return 'IncomeTransactionCreateEvent.fixBalance(balance: $balance)';
  }
...
abstract class _FixBalance implements IncomeTransactionCreateEvent {
...
class __$$SaveImplCopyWithImpl<$Res>
    extends _$IncomeTransactionCreateEventCopyWithImpl<$Res, _$SaveImpl>
...
class _$SaveImpl implements _Save {
  ...
  @override
  String toString() {
    return 'IncomeTransactionCreateEvent.save()';
  }
...
abstract class _Save implements IncomeTransactionCreateEvent {
  const factory _Save() = _$SaveImpl;
}

/// @nodoc
mixin _$IncomeTransactionCreateState {
  Transaction get transaction => throw _privateConstructorUsedError;
  Account get account => throw _privateConstructorUsedError;
  Option<Either<TransactionFailure, Unit>> get failureOrSuccessOption =>
      throw _privateConstructorUsedError;

  /// Create a copy of IncomeTransactionCreateState
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $IncomeTransactionCreateStateCopyWith<IncomeTransactionCreateState>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $IncomeTransactionCreateStateCopyWith<$Res> {
  factory $IncomeTransactionCreateStateCopyWith(
          IncomeTransactionCreateState value,
          $Res Function(IncomeTransactionCreateState) then) =
      _$IncomeTransactionCreateStateCopyWithImpl<$Res,
          IncomeTransactionCreateState>;
  @useResult
  $Res call(
...
/// @nodoc
class _$IncomeTransactionCreateStateCopyWithImpl<$Res,
        $Val extends IncomeTransactionCreateState>
    implements $IncomeTransactionCreateStateCopyWith<$Res> {
  _$IncomeTransactionCreateStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$IncomeTransactionCreateStateImplCopyWith<$Res>
    implements $IncomeTransactionCreateStateCopyWith<$Res> {
  factory _$$IncomeTransactionCreateStateImplCopyWith(
          _$IncomeTransactionCreateStateImpl value,
          $Res Function(_$IncomeTransactionCreateStateImpl) then) =
      __$$IncomeTransactionCreateStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Transaction transaction,
...
/// @nodoc
class __$$IncomeTransactionCreateStateImplCopyWithImpl<$Res>
    extends _$IncomeTransactionCreateStateCopyWithImpl<$Res,
        _$IncomeTransactionCreateStateImpl>
    implements _$$IncomeTransactionCreateStateImplCopyWith<$Res> {
  __$$IncomeTransactionCreateStateImplCopyWithImpl(
      _$IncomeTransactionCreateStateImpl _value,
      $Res Function(_$IncomeTransactionCreateStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$IncomeTransactionCreateStateImpl(
      transaction: null == transaction
          ? _value.transaction
          : transaction // ignore: cast_nullable_to_non_nullable
              as Transaction,
...
class _$IncomeTransactionCreateStateImpl
    implements _IncomeTransactionCreateState {
  const _$IncomeTransactionCreateStateImpl(
  ...
  @override
  String toString() {
    return 'IncomeTransactionCreateState(transaction: $transaction, account: $account, failureOrSuccessOption: $failureOrSuccessOption)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$IncomeTransactionCreateStateImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$IncomeTransactionCreateStateImplCopyWith<
          _$IncomeTransactionCreateStateImpl>
      get copyWith => __$$IncomeTransactionCreateStateImplCopyWithImpl<
          _$IncomeTransactionCreateStateImpl>(this, _$identity);
}

abstract class _IncomeTransactionCreateState
    implements IncomeTransactionCreateState {
  const factory _IncomeTransactionCreateState(
      {required final Transaction transaction,
      required final Account account,
      required final Option<Either<TransactionFailure, Unit>>
          failureOrSuccessOption}) = _$IncomeTransactionCreateStateImpl;
