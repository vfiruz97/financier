...
class IncomeStatisticsBody extends StatefulWidget {
  const IncomeStatisticsBody({
    super.key,
  ...
  @override
  State<IncomeStatisticsBody> createState() => _IncomeStatisticsBodyState();
}

class _IncomeStatisticsBodyState extends State<IncomeStatisticsBody> {
  int _currencyId = 0;
              ...
              children: [
                ...
                StreamBuilder<List<TransactionWithRelationship>>(
                  stream: getIt<TransactionsDao>().watchAllWhereAccountIdInAndDateBetweenAndType(
                    ...
                    type: TransactionCategoryType.income.index,
                  ),
