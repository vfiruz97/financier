                        ...
                        onTap: () {
                          showDialog(
                              ...
                              builder: (_) => const CategoryCreateFormDialog(
                                  transactionCategoryType: TransactionCategoryType.expense));
                        },
                                ...
                                child: InkWell(
                                  onTap: () {
                                    BlocProvider.of<ExpenseTransactionCreateBloc>(context)
                                      ..add(ExpenseTransactionCreateEvent.assignCategoryId(category.id!.getOrCrash()))
                                      ..add(const ExpenseTransactionCreateEvent.save());
                                    onTap();
                                  },
