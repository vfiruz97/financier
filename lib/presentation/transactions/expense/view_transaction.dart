...
class ViewTransaction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final transactionId = BlocProvider.of<ExpenseTransactionCreateBloc>(context).state.transaction.id.getOrCrash();
    final transaction0 = BlocProvider.of<ExpenseTransactionCreateBloc>(context).state.transaction;
    BlocProvider.of<ExpenseTransactionUpdateBloc>(context)
        .add(ExpenseTransactionUpdateEvent.assignTransaction(transaction0));
