...
class _EnterBalanceFormState extends State<EnterBalanceForm> {
  ...
  @override
  void initState() {
    currencyCode = context.read<IncomeTransactionCreateBloc>().state.account.currencyId.code;
    final balance = context.read<IncomeTransactionCreateBloc>().state.transaction.balance.getOrElse(0);
    amount = balance > 0
        ? '$balance'.endsWith('.0')
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  style: Theme.of(context)
                                      .textTheme
                                      .titleSmall
                                      ?.copyWith(fontSize: 24, color: Theme.of(context).colorScheme.primaryContainer),
                            ...
                            child: InkWell(
                              onTap: () {
                                BlocProvider.of<IncomeTransactionCreateBloc>(context)
                                    .add(IncomeTransactionCreateEvent.fixBalance(double.parse(amount)));
                                widget.onTap();
                              },
                              child: const Padding(
