...
class EditIncomeTransactionScreen extends StatelessWidget {
  const EditIncomeTransactionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final transactionId = context.read<IncomeTransactionUpdateBloc>().state.transaction.id.getOrCrash();
                                ...
                                onTap: () async {
                                  ...
                                  if (response != null && response) {
                                    BlocProvider.of<IncomeTransactionUpdateBloc>(context)
                                        .add(const IncomeTransactionUpdateEvent.delete());
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(fieldName, style: const TextStyle(color: Colors.grey, fontWeight: FontWeight.w500, fontSize: 12)),
                const SizedBox(height: 4),
                Text(value, maxLines: 1, style: Theme.of(context).textTheme.titleSmall),
              ],
            ),
          ),
          if (showRigthIcon)
